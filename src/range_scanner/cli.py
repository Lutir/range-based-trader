...
_UNIVERSE_MAP = {
    ...
    "sp500": "sp500.txt",
    "mega_caps": "mega_caps.txt",
    "dividend_aristocrats": "dividend_aristocrats.txt",
    "semiconductors": "semiconductors.txt",
    "software_cloud": "software_cloud.txt",
    "biotech": "biotech.txt",
    "reits": "reits.txt",
    "defense_aerospace": "defense_aerospace.txt",
    "utilities": "utilities.txt",
    "consumer_staples": "consumer_staples.txt",
    "regional_banks": "regional_banks.txt",
    "cannabis": "cannabis.txt",
    "ai_robotics": "ai_robotics.txt",
    "clean_energy": "clean_energy.txt",
    "meme_speculative": "meme_speculative.txt",
    "high_short_interest": "high_short_interest.txt",
    "low_volatility": "low_volatility.txt",
    "sector_etfs": "sector_etfs.txt",
    "international_adrs": "international_adrs.txt",
    "ipo_recent": "ipo_recent.txt",
    "etfs": "etfs.txt",
}
